...
class AppearanceTableViewController: MenuControlsTableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.contentView.backgroundColor = ThemeManager.currentTheme().generalModalControllerBackgroundColor
        cell.appearanceExampleCollectionView.backgroundColor = ThemeManager.currentTheme().generalModalControllerBackgroundColor
        return cell
    }
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        label.backgroundColor = ThemeManager.currentTheme().generalModalControllerBackgroundColor
